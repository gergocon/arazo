      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white p-10 rounded-[3rem] shadow-2xl shadow-[#2b251d]/5 border border-[#e7e8dd]">
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <button 
              disabled={loading}
              className="w-full py-6 bg-[#2b251d] text-[#f7f7f3] font-black rounded-2xl shadow-xl hover:bg-[#4e4639] transition-all uppercase tracking-widest flex items-center justify-center gap-3"
            >
        ...
        <p className="text-center mt-8 text-[#b6b693] text-[10px] font-bold uppercase tracking-widest">
          © 2024 Constructorul Salard - Minden jog fenntartva
        </p>
      </div>
    </div>
  );
